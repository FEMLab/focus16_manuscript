...
ggsave("docs/figures/S6-datasets.png", p_dataset_overlap, device = "png", dpi = 300, width = 6, height = 6)
```
...
summary_data <- rbind(bal_data,ex_data, hmp_data, endo_data)
...
focusdb_headers$genus <- gsub("(.*?) (.*)", "\\1", focusdb_headers$organism)
