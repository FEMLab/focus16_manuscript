...
With short read data, we do not identify more sequences, but we 

```{bash, eval=FALSE} 
fastq-dump --split-files ERR1447466 -O ./pacbio/
```
I ended up downloading with the ENA tools, and I ended up with funny errirs 
