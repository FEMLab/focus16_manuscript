...
```{r accuracy, echo=FALSE, fig.cap=paste0("Assembly errors per kilobase calculated between each ", toolname, " sequence and the reference genome. In the genera considered, 285 sequences from 61 complete genomes were present in SILVA; riboSeed recovered 271 of these.  146 of these 16S alleles were identical between riboSeed and complete genome (grey bar)."), out.width = '60%'}
