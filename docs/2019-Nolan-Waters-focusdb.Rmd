...
Of the organisms, 16 had publicly available WGS data in the SRA database.
 ```{r srafig, echo=FALSE, fig.cap="Strains with whole genome seqeuncing SRAs available", out.width = '100%'}
knitr::include_graphics("figures/srastrains.png")
```
