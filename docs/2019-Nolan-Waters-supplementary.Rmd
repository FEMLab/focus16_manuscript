...
scale_fill_brewer(palette = "Set1") +
  # scale_color_manual(values = viridis::viridis(n=10)[3:5]) +
    ...
    labs("SRAs Proccessed by focusDB",
         y="Number of whole-genome sequencing SRAs", x="", color="focusDB Status", fill="focusDB Status", shape="Per SRA")  +
    theme(axis.text=element_text(size=13),
          axis.title.x =element_text(size=14),
          axis.text.y = element_text(colour = alpha_v))
)  
ggsave("docs/figures/2-success.png", p_outcomes, device = "png", dpi = 300, width = 12, height = 7)
