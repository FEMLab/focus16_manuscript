...
p_summary_data$strain <- factor(p_summary_data$strain, levels=rev(levels(factor(p_summary_data$strain))))
# for coloring x/y axis
alpha_info <-  rev(ifelse(p_summary_data[!duplicated(p_summary_data$strain), "globalmessage"]=="Success", "gray90", "gray60"))
...
(p_outcomes <- ggplot(p_summary_data, 
    ...
    labs("SRAs Proccessed by focusDB",
         y="Number of SRAs", x="", color="focusDB Status", fill="focusDB Status", shape="Per SRA")  +
    theme(axis.text=element_text(size=13),
          axis.text.y = element_text(colour = alpha_v))
)  
ggsave("docs/figures/2-success.png", p_outcomes, device = "png", dpi = 300, width = 11, height = 6)
