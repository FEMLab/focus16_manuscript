...
To provide an assessment of real-world usage of `r toolname`, we used the data generated in the EndoBiota study [@ataEndobiotaStudyComparison2019]^[PRJEB26800]: a survey of microbiomes across three body sites of women with and without endometriosis. These datasets are summarized in Table \@ref(tab:dataset-tab).
