...
ovatus_sras  %>% group_by(assembly) %>% select(assembly, silva) %>% distinct() %>%  summarize(n=n())
```
...
The other three assemblies, we could re-assemble: GCF_000218325.1, GCF_000699665.1, and GCF_900107475.1 all only have a single rDNA.
