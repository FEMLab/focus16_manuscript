...
Next, we assign taxa to the merged ASV table. Matrices for the data with both the SILVA db and our SILVA+ db created with focus16.  This is then used to determine whether the taxonomic assignment changes between the two databases.
