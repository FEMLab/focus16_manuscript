...
cat ./results/2019-11-11-results/*fast_ribo16s.fasta > results/combined_focusDB_seqs.fasta

```
```{r}
silva_orig <- readFasta("~/Downloads/SILVA_132_SSURef_tax_silva.fasta.gz")
focusDB_seqs <- readFasta("path/to/silva_file_rna.fasta")
